...
//    public Integer deleteWords (Integer id) {
//        SQLiteDatabase db = this.getWritableDatabase();
...
//            array_list.add(res.getString(res.getColumnIndex(WORDS_COLUMN_DESCRIPTION)));
...
//        Cursor res =  db.rawQuery( "select * from words", null );
//        res.moveToFirst();
//        String word=res.getString(res.getColumnIndex(WORDS_COLUMN_WORD));
//        res.moveToNext();
//        return word;
//    }
}
